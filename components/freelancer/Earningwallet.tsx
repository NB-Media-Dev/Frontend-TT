    ...
    >
      <div className="flex flex-col gap-4">
        <div className="-mt-1">
          ...
          <div className="text-xl sm:text-2xl font-black text-gray-900 tracking-tight select-text">
            {availableBalance}
          </div>
        </div>
        <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
          ...
          <div className="bg-[#F0F4F8]/70 border border-gray-100/60 rounded-[20px] p-2 sm:p-3 flex flex-col items-center justify-center text-center min-w-0">
            ...
            <span className="text-xs sm:text-sm text-gray-900 mt-0.5 truncate max-w-full font-bold select-text">
              {pendingBalance}
            </span>
          </div>
        ...
        <button
          type="button"
          onClick={onWithdraw}
          className={`w-full py-3 px-3 ${buttonVariants({ variant: 'default' })} text-xs sm:text-sm font-bold shadow-[0_6px_20px_rgba(255,107,53,0.3)] flex items-center justify-center active:scale-[0.99]`}
        >
          Withdraw Funds
        </button>
        ...
        <div className="border border-gray-200/70 rounded-full px-3.5 sm:px-4 py-2.5 flex items-center justify-between gap-2 bg-white">
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex flex-col">
              <span className="text-xs font-bold text-gray-900 leading-tight truncate select-text">
                {bankName}
              </span>
              <span className="text-[11px] font-medium text-gray-400 leading-none mt-0.5 select-text">
                •••• {bankAccountLast4}
              </span>
            </div>
          </div>
          <button
            ...
            className={`${buttonVariants({ variant: 'link' })} text-xs font-bold shrink-0`}
          >
            Change
          </button>
        </div>
