...
import AITrendRadar from "../dashboard/AITrendRadar";
import GlobalTamilReach from "./GlobalTamilReach";
import BreakingNew from "./BreakingNew";
import Liveupdate from "./Liveupdate";
import Reachout from "./Reachout";
import RegionalHightlights from "./RegionalHightlights";

export default function Trendradarcontent() {
