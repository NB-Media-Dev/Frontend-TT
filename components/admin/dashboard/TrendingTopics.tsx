...
export default function TrendingTopics({
  ...
  const tamilTopics: TamilTopic[] = [
    ...
    },
    {
      id: 2,
      rank: 2,
      title: "விஜய் புதிய படம் அறிவிப்பு",
      posts: "18.2K Posts",
      category: "Cinema",
    },
    {
      id: 3,
      rank: 3,
      title: "சட்டமன்ற தேர்தல் அப்டேட்",
      posts: "15.4K Posts",
      category: "Politics",
    },
  ];
  ...
  if (isInfluencer) {
    return (
      <Cardlayout
        title="Trending Tamil Topics"
        icon={null}
        isLoading={isLoading}
        skeleton={
          <ContentSkeleton count={4} height="h-[30px]" width="w-full" />
        }
        action={
          <Link
            href="/influencer"
            ...
            {filteredTamilTopics.map((topic) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="text-[#FF6B35] text-sm sm:text-base font-bold min-w-[14px]">
                    {topic.rank}
                  </span>
