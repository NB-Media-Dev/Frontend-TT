...
export default function Addstories({
  ...
  return (
    <div className="fixed inset-0 top-[52px] xs:top-[40px] sm:top-[20px] md:top-0 bg-black/60 backdrop-blur-xs flex items-start md:items-center justify-center p-0 md:p-4 z-40 animate-in fade-in duration-200">
      <div className="w-full h-full xs:mt-4 md:h-auto md:max-h-[94vh] md:max-w-4xl min-[2560px]:max-w-[1250px] min-[3840px]:max-w-[1550px] rounded-none md:rounded-[28px] bg-[#fff0e7] shadow-2xl px-4 pt-3 pb-24 md:px-6 md:py-5 min-[2560px]:p-6 min-[3840px]:p-8 relative font-sans antialiased border-0 md:border border-orange-100 overflow-y-auto md:overflow-hidden flex flex-col justify-start">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] min-[2560px]:grid-cols-[1fr_390px] min-[3840px]:grid-cols-[1fr_450px] gap-6 min-[3840px]:gap-8 items-start mt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-full h-8 sm:h-9 px-3 rounded-xl bg-white border border-transparent outline-none text-xs transition-all shadow-xs focus:border-[#ef8b54] placeholder:text-gray-400 text-gray-800"
                />
              </div>
            </div>
