          ...
          {creators.map((creator) => (
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 w-full">
                <h3 className="text-xs font-extrabold text-gray-900 truncate max-w-[110px] mx-auto">
                  {creator.name}
                </h3>
        ...
        <div className="hidden lg:flex flex-col gap-3.5">
          {creators.map((creator) => (
            ...
            >
              ...
              <button
                className={`px-4 py-1.5 border border-[#FF5A26]/30 text-[#FF5A26] text-[10px] font-black rounded-full transition-all cursor-pointer shrink-0 ${buttonVariants({ variant: "hoverButton" })}`}
              >
                Follow
              </button>
            </div>
