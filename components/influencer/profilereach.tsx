  ...
  return (
    <div className="w-full bg-white border border-gray-100 rounded-[20px] sm:rounded-[28px] p-4 sm:p-5 md:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.03)] select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-5 sm:mb-6">
        <div>
          <h1 className="text-lg sm:text-2xl text-gray-900 tracking-tight flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto shrink-0">
          ...
          <div className="relative">
            <button
              ...
              className="bg-white hover:bg-gray-50 border border-gray-200 rounded-full px-3.5 py-1.5 text-xs  text-gray-800 flex items-center gap-2 shadow-xs transition-all cursor-pointer"
            >
              <span>{workspace}</span>
          ...
          return (
            ...
            >
              ...
              <div className="mt-2.5 sm:mt-3">
                <div className="text-base sm:text-lg lg:text-xl  text-gray-900 tracking-tight whitespace-nowrap">
                  {item.value}
                </div>
                <div className="flex items-center gap-1 text-[10px] sm:text-[11px] text-[#10B981] mt-1 whitespace-nowrap">
